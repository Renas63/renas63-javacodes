...
public class Task5ArrayDescending {
    /*
    Create one method takes String Arraylist with duplicate values, this method need to return array with descending order of unique element from arrayList.
