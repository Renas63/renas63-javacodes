...
loop the string letter if the letter is equals to the "d" then check
 after second char is also equals to d then print dad
         */
        System.out.println(" Please enter  a string value");
        String string = input.nextLine().toLowerCase();

        String word=string.substring(string.indexOf("d"), string.indexOf("d")+3);
